...
let handler = async(m, { conn, text, usedPrefix, command }) => {
    ...
    message: `owner bot`, 
    orderTitle: ``,
    thumbnail: await conn.resize(await (await fetch('https://telegra.ph/file/96938a7edf09f5511ce10.jpg')).buffer(), 300, 200) //Gambarnye
...
let cap = `Hay kak @${await m.sender.split('@')[0]}, itu nomor ownerku jangan dispam yah ^_^` 
  let buttonMessage= {
'document':{'url':'https://chat.whatsapp.com/EPmjuw9X1wZDGX1p4NCV1e'},
...
'caption':cap,
'footer':`Itu Owner Ku Yah Kak Jangan Sungkan Untuk Chat 🗿☕
