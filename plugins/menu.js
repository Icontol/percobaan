...
%readmore`.trimStart(),
  ...
  footer: '┗━━━━━━━━━ꕥ\n',
  after: `  ${'✧\n┏━📮 *Note* :\n┃ 𝙹𝙸𝙺𝙰 𝙼𝙴𝙻𝙰𝙽𝙶𝙶𝙰𝚁 𝚃𝙾𝚂 𝙰𝙺𝙰𝙽 𝙳𝙸 𝙱𝙰𝙽 𝙿𝙴𝚁𝙼𝙰𝙽𝙴𝙽!\n┗━━━━━━━━━━━━━━━━━━━ꕥ'}`,
}
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://telegra.ph/file/079b29517ff3177dc9f8e.jpg'
...
`, text.trim(), flaa, [
    ...
    ], m, { 'document':{'url':'https://chat.whatsapp.com/EPmjuw9X1wZDGX1p4NCV1e'},
...
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        ...
                        mediaType: 2,
                        //description: `⚘ ᴄʀᴇᴀᴛᴇ Nathaliee Azzahra ×፝֟͜×`,
                        //title: `💌 My Ultah: ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
                       // body: `⚘ by Sansbot`,          previewType: 0,
